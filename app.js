...
function sumArray(testArray){ //eslint-disable-line
  ...
  for (var i = 0; i < testArray.length; i++) {
    finalSum = sum(finalSum, testArray[i])[0];
    console.log('final sum:', finalSum);
  }
  var sumArrayMessage = testArray + ' was passed in as an array of numbers, and ' + finalSum + ' is their sum.';
  console.log(sumArrayMessage);
  return [finalSum, sumArrayMessage];
}
...
function multiplyArray(testArray){ //eslint-disable-line
  var finalProd = 1;
  for (var i = 0; i < testArray.length; i++) {
    finalProd = multiply(finalProd, testArray[i])[0];
    console.log('final product:', finalProd);
  }
  var multArrayMessage = 'The numbers ' + testArray + ' have a product of ' + finalProd + '.';
  return[finalProd, multArrayMessage];
}
